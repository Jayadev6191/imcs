...
var On24Util = (function (options, undefined) {
    ...
    return {
         ...
         * @return {String}
         */
        getCategoryStr : function (categories, model, parentCategoryId) {
            var str = "";
            ...
            if (categories) {
                ...
                for (var i= 0; i < model.categories.length; i++) {
                    if (categoryMap[model.categories[i]].parentId == parentCategoryId) {
                        if (str != "") {
                            str += ", ";
                        }
                        str += categoryMap[model.categories[i]].name.toUpperCase();
                    }
                }
...
var On24Store= (function (options, undefined) {
    ...
    var _apiCache = {},
        ...
        actualSort,
        baseURL = "http://localhost.on24.com/vshow/";
    ...
    return {
        ...
        findById : function (parameters) {
            ...
            if (type === "singlecontent") {
                serviceURL += "&externalResourceId=" + externalId + "&currentTradeshowId=" + showId;
            }
...
(function($){
    ...
    $.fn.builder = function(options) {
        ...
        var settings = $.extend(true,{
            prefix:                     'on24',
            container:                  'body',
            supportedFields:            ["category", "content", "user", "featuredcontent"],
            hideContent:                false,
            ...
            derived : {
                ...
                "assetTypes" : function (model, assetType, categories) {
                    ...
                    return On24Util.getCategoryStr(categories, model, assetType);
                },
                ...
                "interestAreasType" : function (model, interestAreasType, categories) {
                    ...
                    return On24Util.getCategoryStr(categories, model, interestAreasType);
                },
                "rolesType" : function (model, rolesType, categories) {

                    return On24Util.getCategoryStr(categories, model, rolesType);
                },
                ...
                "d2c_url" : function (model,site) {
                    var link =  "http://localhost.on24.com/content/";
                    link += model.externalResourceId;
            ...
            actionMap: {
                ...
                "content" : {
                    "url" :                 "/?command=rsrc&action=getResourcesByCategory&f=json",
                    "dataType" :            "json",//"text/json; charset=utf-8",
                    "contentType":          "text/json",
                    "paramName":            "resources",
                    "modelName":            "content",
                ...
                "featuredcontent" : {
                    "url" :                 "/?command=rsrc&action=getResourcesByCategory&f=json&isFeatured=Y",
                    "dataType" :            "json",//"text/json; charset=utf-8",
                    "contentType":          "text/json",
                    "paramName":            "resources",
                ...
                "singlecontent" : {
                    "url" :                 "?command=rsrc&action=getResourceAndRelatedContent&f=json",//&externalResourceId=ext1 resourceId
                    "dataType" :            "json",
                    "contentType":          "text/json",
                    "modelName":            "content",
                    "type" :                "get",
                                ...
                                if (model != null) {
                                    ...
                                    if (urlMap.isModel === true) {
                                        ...
                                        if (urlMap.model == "singlecontent") {
                                            ...
                                            var parameters = {
                                                content: model,
                                                action: settings.actionMap["updateContentLog"],
                                                settings: settings
                                            };
        ...
        function updateProfile ($node, data, eventItem) {
            ...
            selectedFilters, action, showCode, loggedUser, showId
                ...
                if (field && field != "") {
                    ...
                    if (actionInfo.helper && actionInfo.helper[field]) {
                        ...
                        if ($.isArray(model[field])) {
                            ...
                            if (settings.derived[field]) {
                                if (field == "assetTypes") {
                                    $(domItem).text(settings.derived[field](model, settings.assetTypes, On24Store.getStore()["category"]));
                                    ...
                                    $(domItem).text(settings.derived[field](model, settings.interestAreasType, On24Store.getStore()["category"]));
                                } else if (field == "rolesType") {
                                    $(domItem).text(settings.derived[field](model, settings.rolesType, On24Store.getStore()["category"]));
                                } else if (field == "d2c_url") {
                                    var link = "";
                                    if (settings.derived[field]) {
