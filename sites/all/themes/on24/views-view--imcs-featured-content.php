...
<h2>this is views-view--imcs-featured-content.php</h2>
    ...
    <div id="single-content-container">
        <div class="single-content-item" data-on24-singlecontent="repeat">
            <div class="img-container">
                <img src="img/contentImage_none.png" alt="content-image" height="30" width="50"/>
                <p class="asset-type-label" data-on24-field="assetType"></p>
            </div>

            <p class="category-label">Category: <span data-on24-field="category"></span></p>
            ...
            <div class="content-info">
                ...
                <p class="title-label"><span data-on24-field="title">Data from Drupal:title</span></p>
                <p class="abstract-label"><span data-on24-field="description">Data from Drupal:description</span></p>
                <p class="teaser-label"><span data-on24-field="teaser">Data from Drupal:teaser</span></p>
                <div class="login-section">
                    <a class="link-label"><span>Sign In</span></a>
                    <div class="social-link-container">
                        <img src="img/socialLinks_none.png" alt="social links image"/>
                    </div>
                </div>
...
<h2>Related Content</h2>
   <div class="related-content-container" data-on24-relatedcontent="repeat">
            <div class="content-item">
                ...
                <p class="title-label"><span data-on24-field="title">related: title</span></p>
                <p class="abstract-label"><span data-on24-field="description">related: description</span></p>
...
<script language="javascript" type="text/javascript">
  console.log('node--asset.tpl.php: setting up the onready');
    ...
    $(document).ready(function(){
      ...
      console.log('node--asset.tpl.php: onready is set up');
